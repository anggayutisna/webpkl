                          ...
                          @endforeach
                            ...
                            <div class="post-author d-flex align-items-center">
                                <div class="post-author-thumb">
                                    <img src="frontend/mag/img/bg-img/52.jpg" alt="">
                                </div>
                        ...
                        <ol>
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-content d-flex">
                                    ...
                                    <div class="comment-author">
                                        <img src="frontend/mag/img/bg-img/53.jpg" alt="author">
                                    </div>
                                    <!-- Comment Meta -->
                                ...
                                <ol class="children">
                                    <li class="single_comment_area">
                                        ...
                                        <div class="comment-content d-flex">
                                            <!-- Comment Author -->
                                            <div class="comment-author">
                                                <img src="frontend/mag/img/bg-img/54.jpg" alt="author">
                                            </div>
                                            <!-- Comment Meta -->
                                            <div class="comment-meta">
                                                <a href="#" class="comment-date">27 Aug 2019</a>
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-content d-flex">
                                    <!-- Comment Author -->
                                    <div class="comment-author">
                                        <img src="frontend/mag/img/bg-img/55.jpg" alt="author">
                                    </div>
                                    <!-- Comment Meta -->
                                    <div class="comment-meta">
                                        <a href="#" class="comment-date">27 Aug 2019</a>
