...
class FrontendAPIController extends Controller
{
    ...
    public function index()
    {
        ...
        $artikel = Artikel::select('artikels.title', 'artikels.slug', 'headline', 'image', 'kategoris.title as kategori', 'users.name as author')
            ->join('users', 'users.id', '=', 'artikels.user_id')
            ->join('kategori', 'kategori.id', '=', 'artikels.kategori_id')
            ->paginate(2);
